...
fn llamaGenerate(
    ...
    return families_mod.FamilyReport{
        ...
        .exp_block_trace = report.exp_block_trace,
        .exp_block_acceptance_threshold = report.exp_block_acceptance_threshold,
        .exp_block_acceptance_window = report.exp_block_acceptance_window,
        .exp_block_disable_steps = report.exp_block_disable_steps,
        .exp_block_precheck_margin_multiplier = report.exp_block_precheck_margin_multiplier,
        ...
        .block_quality_gate_active_count = report.block_quality_gate_active_count,
        .block_quality_gate_trigger_count = report.block_quality_gate_trigger_count,
        .block_precheck_count = report.block_precheck_count,
        .block_precheck_fail_count = report.block_precheck_fail_count,
        .block_draft_pos1_count = report.block_draft_pos1_count,
        .block_draft_pos2_count = report.block_draft_pos2_count,
        .block_draft_pos3_count = report.block_draft_pos3_count,
        .block_draft_pos4_count = report.block_draft_pos4_count,
        .block_accept_pos1_count = report.block_accept_pos1_count,
        .block_accept_pos2_count = report.block_accept_pos2_count,
        .block_accept_pos3_count = report.block_accept_pos3_count,
        .block_accept_pos4_count = report.block_accept_pos4_count,
        .block_mismatch_pos0_count = report.block_mismatch_pos0_count,
        .block_mismatch_pos1_count = report.block_mismatch_pos1_count,
        .block_mismatch_pos2_count = report.block_mismatch_pos2_count,
        .block_mismatch_pos3_count = report.block_mismatch_pos3_count,
        .block_full_accept_count = report.block_full_accept_count,
