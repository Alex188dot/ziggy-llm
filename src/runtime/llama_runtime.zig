...
pub fn generate(
    ...
    return .{
        ...
        .exp_block_trace = llama_report.exp_block_trace,
        .exp_block_acceptance_threshold = llama_report.exp_block_acceptance_threshold,
        .exp_block_acceptance_window = llama_report.exp_block_acceptance_window,
        .exp_block_disable_steps = llama_report.exp_block_disable_steps,
        .exp_block_precheck_margin_multiplier = llama_report.exp_block_precheck_margin_multiplier,
        ...
        .block_cooldown_active_count = llama_report.block_cooldown_active_count,
        .block_quality_gate_active_count = llama_report.block_quality_gate_active_count,
        .block_quality_gate_trigger_count = llama_report.block_quality_gate_trigger_count,
        .block_precheck_count = llama_report.block_precheck_count,
        .block_precheck_fail_count = llama_report.block_precheck_fail_count,
        .block_draft_pos1_count = llama_report.block_draft_pos1_count,
        .block_draft_pos2_count = llama_report.block_draft_pos2_count,
        .block_draft_pos3_count = llama_report.block_draft_pos3_count,
        .block_draft_pos4_count = llama_report.block_draft_pos4_count,
        .block_accept_pos1_count = llama_report.block_accept_pos1_count,
        .block_accept_pos2_count = llama_report.block_accept_pos2_count,
        .block_accept_pos3_count = llama_report.block_accept_pos3_count,
        .block_accept_pos4_count = llama_report.block_accept_pos4_count,
        .block_mismatch_pos0_count = llama_report.block_mismatch_pos0_count,
        .block_mismatch_pos1_count = llama_report.block_mismatch_pos1_count,
        .block_mismatch_pos2_count = llama_report.block_mismatch_pos2_count,
        .block_mismatch_pos3_count = llama_report.block_mismatch_pos3_count,
        .block_full_accept_count = llama_report.block_full_accept_count,
