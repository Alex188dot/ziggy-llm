...
pub const BenchSummary = struct {
    ...
    warm_block_quality_gate_active_count_avg: usize = 0,
    warm_block_quality_gate_trigger_count_avg: usize = 0,
    warm_block_precheck_count_avg: usize = 0,
    warm_block_precheck_fail_count_avg: usize = 0,
    warm_block_draft_pos1_count_avg: usize = 0,
    warm_block_draft_pos2_count_avg: usize = 0,
    warm_block_draft_pos3_count_avg: usize = 0,
    warm_block_draft_pos4_count_avg: usize = 0,
    warm_block_accept_pos1_count_avg: usize = 0,
    warm_block_accept_pos2_count_avg: usize = 0,
    warm_block_accept_pos3_count_avg: usize = 0,
    warm_block_accept_pos4_count_avg: usize = 0,
    warm_block_mismatch_pos0_count_avg: usize = 0,
    warm_block_mismatch_pos1_count_avg: usize = 0,
    warm_block_mismatch_pos2_count_avg: usize = 0,
    warm_block_mismatch_pos3_count_avg: usize = 0,
    warm_block_full_accept_count_avg: usize = 0,
...
pub fn runWarmBench(
    ...
    var warm_block_quality_gate_active_count_total: u128 = 0;
    var warm_block_quality_gate_trigger_count_total: u128 = 0;
    var warm_block_precheck_count_total: u128 = 0;
    var warm_block_precheck_fail_count_total: u128 = 0;
    var warm_block_draft_pos1_count_total: u128 = 0;
    var warm_block_draft_pos2_count_total: u128 = 0;
    var warm_block_draft_pos3_count_total: u128 = 0;
    var warm_block_draft_pos4_count_total: u128 = 0;
    var warm_block_accept_pos1_count_total: u128 = 0;
    var warm_block_accept_pos2_count_total: u128 = 0;
    var warm_block_accept_pos3_count_total: u128 = 0;
    var warm_block_accept_pos4_count_total: u128 = 0;
    var warm_block_mismatch_pos0_count_total: u128 = 0;
    var warm_block_mismatch_pos1_count_total: u128 = 0;
    var warm_block_mismatch_pos2_count_total: u128 = 0;
    var warm_block_mismatch_pos3_count_total: u128 = 0;
    var warm_block_full_accept_count_total: u128 = 0;
    ...
    for (1..bench_runs) |_| {
        ...
        warm_block_quality_gate_active_count_total += warm.block_quality_gate_active_count;
        warm_block_quality_gate_trigger_count_total += warm.block_quality_gate_trigger_count;
        warm_block_precheck_count_total += warm.block_precheck_count;
        warm_block_precheck_fail_count_total += warm.block_precheck_fail_count;
        warm_block_draft_pos1_count_total += warm.block_draft_pos1_count;
        warm_block_draft_pos2_count_total += warm.block_draft_pos2_count;
        warm_block_draft_pos3_count_total += warm.block_draft_pos3_count;
        warm_block_draft_pos4_count_total += warm.block_draft_pos4_count;
        warm_block_accept_pos1_count_total += warm.block_accept_pos1_count;
        warm_block_accept_pos2_count_total += warm.block_accept_pos2_count;
        warm_block_accept_pos3_count_total += warm.block_accept_pos3_count;
        warm_block_accept_pos4_count_total += warm.block_accept_pos4_count;
        warm_block_mismatch_pos0_count_total += warm.block_mismatch_pos0_count;
        warm_block_mismatch_pos1_count_total += warm.block_mismatch_pos1_count;
        warm_block_mismatch_pos2_count_total += warm.block_mismatch_pos2_count;
        warm_block_mismatch_pos3_count_total += warm.block_mismatch_pos3_count;
        warm_block_full_accept_count_total += warm.block_full_accept_count;
    ...
    return .{
        ...
        .warm_block_quality_gate_active_count_avg = @intCast(warm_block_quality_gate_active_count_total / warm_runs),
        .warm_block_quality_gate_trigger_count_avg = @intCast(warm_block_quality_gate_trigger_count_total / warm_runs),
        .warm_block_precheck_count_avg = @intCast(warm_block_precheck_count_total / warm_runs),
        .warm_block_precheck_fail_count_avg = @intCast(warm_block_precheck_fail_count_total / warm_runs),
        .warm_block_draft_pos1_count_avg = @intCast(warm_block_draft_pos1_count_total / warm_runs),
        .warm_block_draft_pos2_count_avg = @intCast(warm_block_draft_pos2_count_total / warm_runs),
        .warm_block_draft_pos3_count_avg = @intCast(warm_block_draft_pos3_count_total / warm_runs),
        .warm_block_draft_pos4_count_avg = @intCast(warm_block_draft_pos4_count_total / warm_runs),
        .warm_block_accept_pos1_count_avg = @intCast(warm_block_accept_pos1_count_total / warm_runs),
        .warm_block_accept_pos2_count_avg = @intCast(warm_block_accept_pos2_count_total / warm_runs),
        .warm_block_accept_pos3_count_avg = @intCast(warm_block_accept_pos3_count_total / warm_runs),
        .warm_block_accept_pos4_count_avg = @intCast(warm_block_accept_pos4_count_total / warm_runs),
        .warm_block_mismatch_pos0_count_avg = @intCast(warm_block_mismatch_pos0_count_total / warm_runs),
        .warm_block_mismatch_pos1_count_avg = @intCast(warm_block_mismatch_pos1_count_total / warm_runs),
        .warm_block_mismatch_pos2_count_avg = @intCast(warm_block_mismatch_pos2_count_total / warm_runs),
        .warm_block_mismatch_pos3_count_avg = @intCast(warm_block_mismatch_pos3_count_total / warm_runs),
        .warm_block_full_accept_count_avg = @intCast(warm_block_full_accept_count_total / warm_runs),
